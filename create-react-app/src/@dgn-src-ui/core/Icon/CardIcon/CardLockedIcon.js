...
const CardLockedIcon = props => {
  let { className, ...other } = props;

  return (
    <Icon
      className={cx(className, styles.Icon__Card, styles.Icon__Card__Locked)}
      {...other}
    >
      <svg
      ...
      >
        <g fill="white" fillRule="evenodd">
          ...
          <g stroke="#1A587E" transform="translate(41 24)">
            <path d="M4.5 12.5h3V7.988l.005-.212A4.5 4.5 0 0 1 16.5 8v4.5h3V8a7.5 7.5 0 0 0-15 0v4.5z" />
