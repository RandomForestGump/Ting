...
interface IDateBoxOptions extends Properties, IHtmlOptions {
...
declare class DateBox extends BaseComponent<IDateBoxOptions> {
    get instance(): dxDateBox;
    protected _WidgetClass: typeof dxDateBox;
...
export { DateBox, IDateBoxOptions, Animation, IAnimationProps, At, IAtProps, BoundaryOffset, IBoundaryOffsetProps, Button, IButtonProps, CalendarOptions, ICalendarOptionsProps, Collision, ICollisionProps, DisplayFormat, IDisplayFormatProps, DropDownOptions, IDropDownOptionsProps, From, IFromProps, Hide, IHideProps, My, IMyProps, Offset, IOffsetProps, Options, IOptionsProps, Position, IPositionProps, Show, IShowProps, To, IToProps, ToolbarItem, IToolbarItemProps };
