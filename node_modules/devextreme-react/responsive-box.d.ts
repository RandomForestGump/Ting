...
interface IResponsiveBoxOptions<TItem = any, TKey = any> extends Properties<TItem, TKey>, IHtmlOptions {
...
declare class ResponsiveBox<TItem, TKey> extends BaseComponent<IResponsiveBoxOptions<TItem, TKey>> {
