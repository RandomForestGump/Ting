...
interface IMultiViewOptions<TItem = any, TKey = any> extends Properties<TItem, TKey>, IHtmlOptions {
...
declare class MultiView<TItem, TKey> extends BaseComponent<IMultiViewOptions<TItem, TKey>> {
