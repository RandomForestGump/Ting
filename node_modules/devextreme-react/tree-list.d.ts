...
interface ITreeListOptions<TRowData = any, TKey = any> extends Properties<TRowData, TKey>, IHtmlOptions {
...
declare class TreeList<TRowData, TKey> extends BaseComponent<ITreeListOptions<TRowData, TKey>> {
    get instance(): dxTreeList;
    protected _WidgetClass: typeof dxTreeList;
...
interface ITreeListHeaderFilterProps {
    allowSearch?: any;
    height?: any;
    searchTimeout?: any;
    texts?: object | {
...
declare class TreeListHeaderFilter extends NestedOption<ITreeListHeaderFilterProps> {
    static OptionName: string;
    static ExpectedChildren: {
        texts: {
            optionName: string;
...
interface ITreeListHeaderFilterTextsProps {
    cancel?: any;
    emptyValue?: any;
    ok?: any;
}
declare class TreeListHeaderFilterTexts extends NestedOption<ITreeListHeaderFilterTextsProps> {
    static OptionName: string;
}
