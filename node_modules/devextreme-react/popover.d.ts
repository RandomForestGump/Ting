...
interface IPopoverOptions extends Properties, IHtmlOptions {
...
declare class Popover extends BaseComponent<IPopoverOptions> {
    get instance(): dxPopover;
    protected _WidgetClass: typeof dxPopover;
