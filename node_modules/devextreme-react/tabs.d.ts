...
interface ITabsOptions<TItem = any, TKey = any> extends Properties<TItem, TKey>, IHtmlOptions {
...
declare class Tabs<TItem, TKey> extends BaseComponent<ITabsOptions<TItem, TKey>> {
    get instance(): dxTabs;
