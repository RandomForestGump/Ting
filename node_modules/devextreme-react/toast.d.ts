...
interface IToastOptions extends Properties, IHtmlOptions {
...
declare class Toast extends BaseComponent<IToastOptions> {
    get instance(): dxToast;
    protected _WidgetClass: typeof dxToast;
...
export { Toast, IToastOptions, Animation, IAnimationProps, At, IAtProps, BoundaryOffset, IBoundaryOffsetProps, Collision, ICollisionProps, From, IFromProps, Hide, IHideProps, My, IMyProps, Offset, IOffsetProps, Position, IPositionProps, Show, IShowProps, To, IToProps };
