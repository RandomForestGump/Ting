...
interface IBoxOptions<TItem = any, TKey = any> extends Properties<TItem, TKey>, IHtmlOptions {
...
declare class Box<TItem, TKey> extends BaseComponent<IBoxOptions<TItem, TKey>> {
    get instance(): dxBox;
