...
interface IContextMenuOptions<TKey = any> extends Properties<TKey>, IHtmlOptions {
...
declare class ContextMenu<TKey> extends BaseComponent<IContextMenuOptions<TKey>> {
