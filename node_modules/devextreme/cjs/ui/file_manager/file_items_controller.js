...
var FileItemsController = function() {
    ...
    _proto.createDirectory = function(parentDirectoryInfo, name) {
        ...
        return this._processEditAction(actionInfo, (function(args) {
            ...
            args.name = name;
            _this6._editingEvents.onDirectoryCreating(args)
        }), (function() {
            return _this6._fileProvider.createDirectory(parentDirItem, name).done((function(info) {
            ...
            _this6._editingEvents.onDirectoryCreated(args)
        }), (function() {
    ...
    _proto.renameItem = function(fileItemInfo, name) {
        ...
        return this._processEditAction(actionInfo, (function(args, itemInfo) {
            ...
            args.newName = name;
            _this7._editingEvents.onItemRenaming(args)
        }), (function(item) {
            return _this7._fileProvider.renameItem(item, name)
        }), (function() {
            var args = {
                sourceItem: sourceItem,
                itemName: name
            };
            _this7._editingEvents.onItemRenamed(args)
        }), (function() {
    ...
    _proto.moveItems = function(itemInfos, destinationDirectory) {
        ...
        return this._processEditAction(actionInfo, (function(args, itemInfo) {
            ...
            _this8._editingEvents.onItemMoving(args)
        }), (function(item) {
            return _this8._fileProvider.moveItems([item], destinationDirectory.fileItem)
        }), (function(itemInfo) {
            var args = {
            ...
            _this8._editingEvents.onItemMoved(args)
        }), (function() {
    ...
    _proto.copyItems = function(itemInfos, destinationDirectory) {
        ...
        return this._processEditAction(actionInfo, (function(args, itemInfo) {
            args.item = itemInfo.fileItem;
            args.destinationDirectory = destinationDirectory.fileItem;
            _this9._editingEvents.onItemCopying(args)
        }), (function(item) {
            return _this9._fileProvider.copyItems([item], destinationDirectory.fileItem)
        }), (function(itemInfo) {
            var args = {
                sourceItem: itemInfo.fileItem,
                parentDirectory: destinationDirectory.fileItem,
            ...
            _this9._editingEvents.onItemCopied(args)
        }), (function() {
    ...
    _proto.deleteItems = function(itemInfos) {
        ...
        return this._processEditAction(actionInfo, (function(args, itemInfo) {
            args.item = itemInfo.fileItem;
            _this10._editingEvents.onItemDeleting(args)
        }), (function(item) {
            return _this10._fileProvider.deleteItems([item])
        }), (function(itemInfo) {
            return _this10._editingEvents.onItemDeleted({
    ...
    _proto.uploadFileChunk = function(fileData, chunksInfo, destinationDirectory) {
        ...
        if (0 === chunksInfo.chunkIndex) {
            ...
            startDeferred = this._processBeforeItemEditAction((function(args) {
                ...
                _this12._editingEvents.onFileUploading(args)
            }))
        } else {
            startDeferred = (new _deferred.Deferred).resolve().promise()
        }
        var result = startDeferred.then((function() {
            return _this12._fileProvider.uploadFileChunk(fileData, chunksInfo, destinationDirectory)
        }));
        if (chunksInfo.chunkIndex === chunksInfo.chunkCount - 1) {
            result = result.done((function() {
                ...
                _this12._editingEvents.onFileUploaded(args)
            }))
        }
        return result
    };
    ...
    _proto.downloadItems = function(itemInfos) {
        ...
        var deferreds = itemInfos.map((function(itemInfo) {
            return _this13._processBeforeItemEditAction((function(args) {
                args.item = itemInfo.fileItem;
                _this13._editingEvents.onItemDownloading(args)
            }), itemInfo)
        }));
        (0, _uiFile_manager.whenSome)(deferreds, null, (function() {
            ...
            if (!canceled) {
                ...
                _this13._fileProvider.downloadItems(items)
            }
        }))
    };
    ...
    _proto._processEditAction = function(actionInfo, beforeAction, action, afterAction, completeAction) {
        ...
        var actionResult = actionInfo.itemInfos.map((function(itemInfo, itemIndex) {
            return _this14._processBeforeItemEditAction(beforeAction, itemInfo).then((function() {
        ...
        return (0, _uiFile_manager.whenSome)(actionResult, (function(info) {
            return _this14._raiseCompleteEditActionItem(actionInfo, info)
        }), (function(errorInfo) {
            return _this14._raiseEditActionItemError(actionInfo, errorInfo)
        })).then((function() {
            completeAction();
            _this14._raiseCompleteEditAction(actionInfo)
        }))
    };
    ...
    _proto.refresh = function() {
        ...
        return this._executeDataLoad((function() {
            return _this15._refreshDeferred = _this15._refreshInternal()
        }), "refresh")
    };
    _proto._refreshInternal = function() {
        ...
        return this._loadItemsRecursive(this._rootDirectoryInfo, cachedRootInfo).then((function() {
            var dirInfo = _this16._findDirectoryByPathKeyParts(selectedKeyParts);
            _this16.setCurrentDirectory(dirInfo);
            delete _this16._lockRefresh
        }))
    };
        ...
        return this.getDirectories(directoryInfo).then((function(dirInfos) {
            ...
            var _loop = function(i) {
                ...
                if (dirInfos[i].expanded) {
                    itemDeferreds.push(_this17._loadItemsRecursive(dirInfos[i], cachedItem))
                }
            };
    ...
    _proto._initialize = function() {
        ...
        var completeInitialization = function() {
            _this18._isInitialized = true;
            _this18._raiseInitialized()
        };
        if (result) {
