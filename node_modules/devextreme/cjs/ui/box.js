...
var FALLBACK_MAIN_SIZE_MAP = {
    row: {
        name: "width",
        getter: _size.getWidth,
        setter: _size.setWidth
    },
    col: {
        name: "height",
        getter: _size.getHeight,
        setter: _size.setHeight
    }
};
...
var FallbackLayoutStrategy = function() {
    ...
    _proto3._contentSize = function(item) {
        return FALLBACK_MAIN_SIZE_MAP[this._option("direction")].getter((0, _renderer.default)(item))
    };
