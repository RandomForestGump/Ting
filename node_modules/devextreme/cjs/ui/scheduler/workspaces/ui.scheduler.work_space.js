...
var SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto.renderRAllDayPanel = function() {
        ...
        if (visible) {
            ...
            _utils2.utils.renovation.renderComponent(this, this._$allDayPanel, _layout2.default, "renovatedAllDayPanel", options);
    ...
    _proto.renderRTimeTable = function() {
        _utils2.utils.renovation.renderComponent(this, this._$timePanel, _layout3.default, "renovatedTimePanel", {
