...
var KeyboardNavigationController = _uiGrid_core.default.ViewController.inherit({
    ...
    _getMaxHorizontalOffset: function() {
        ...
        var rowsView = this.getView("rowsView");
        var offset = scrollable ? scrollable.scrollWidth() - (0, _size.getWidth)(rowsView.element()) : 0;
        return offset
    },
    ...
    _checkCellOverlapped: function($cell) {
        ...
        if (hasScrollable) {
            if (cellOffset.left < 0) {
                isOverlapped = (0, _size.getWidth)($cell) + cellOffset.left <= 0
            } else if (cellOffset.top < 0) {
                isOverlapped = (0, _size.getHeight)($cell) + cellOffset.top <= 0
            }
        }
        return isOverlapped
    },
    ...
    _isVirtualRowRender: function() {
        return this._isVirtualScrolling() || _uiGrid_core2.default.isVirtualRowRendering(this)
    },
