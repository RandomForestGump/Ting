...
var VirtualScrollingDataSourceAdapterExtender = function() {
    ...
    var result = {
        ...
        _handleDataLoading: function(options) {
            ...
            if (!options.isCustomLoading && false === this.option(LEGACY_SCROLLING_MODE) && loadPageCount > 1) {
            ...
            data: function() {
                var members = {
                    ...
                    getLoadPageParams: function(byLoadedPage) {
                        var _this$_dataSource, _this$_dataSource2;
                        var pageSize = this.pageSize();
                        var viewportParams = this._loadViewportParams;
                        var lastLoadOptions = null === (_this$_dataSource = this._dataSource) || void 0 === _this$_dataSource ? void 0 : _this$_dataSource.lastLoadOptions();
                        ...
                        var totalCountCorrection = (null === (_this$_dataSource2 = this._dataSource) || void 0 === _this$_dataSource2 ? void 0 : _this$_dataSource2.totalCountCorrection()) || 0;
                    ...
                    loadViewport: function(params) {
                        var _ref = null !== params && void 0 !== params ? params : {},
                            checkLoadedParamsOnly = _ref.checkLoadedParamsOnly,
                            checkLoading = _ref.checkLoading;
                        var virtualPaging = isVirtualPaging(this);
                    ...
                    isEmpty: function() {
                        return false === this.option(LEGACY_SCROLLING_MODE) && isVirtualPaging(this) ? !this._itemCount : this.callBase(this, arguments)
                    },
