...
var HeaderFilterController = _uiGrid_core.default.ViewController.inherit({
    ...
    getDataSource: function(column) {
        ...
        var group = _uiGrid_core2.default.getHeaderFilterGroupParameters(column, null === dataSource || void 0 === dataSource ? void 0 : dataSource.remoteOperations().grouping);
            ...
            options.dataSource = {
                ...
                load: function(options) {
                    ...
                    dataSource.load(options).done((function(data) {
                        var convertUTCDates = isUTCFormat(column.serializationFormat) && cutoffLevel > 3;
                        if (convertUTCDates) {
