...
var styles$h = require('@material-ui/core/styles');
...
var _excluded = ["className", "classes"];
...
var withClassName = function withClassName() {
  ...
  return function (Target) {
    return styles$h.withStyles.apply(void 0, args)(dxReactChart.withPatchedProps(setClassName)(Target));
  };
};
...
var Label$1 = withClassName(styles$3, {
  ...
  return /*#__PURE__*/React.createElement(ListItemText, restProps, text);
});
...
var Point = styles$h.withStyles(styles$6)(dxReactChart.withPatchedProps(setClassName)(dxReactChart.ScatterSeries.Point));
...
var _excluded$5 = ["classes", "className", "children", "target", "rotated", "arrowComponent"];
...
var Overlay = styles$h.withStyles(styles$c)(OverlayBase);
...
var Content = withClassName(styles$d, {
  ...
  return /*#__PURE__*/React.createElement(Typography, restProps, text);
});

var _excluded$7 = ["classes", "className", "placement"];
...
var BaseArrow = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var classes = _ref.classes,
      className = _ref.className,
...
var Arrow = styles$h.withStyles(styles$e)(BaseArrow);
...
var Sheet = withClassName(styles$f)(function (props) {
  return /*#__PURE__*/React.createElement(Paper, props);
});
...
var DragBox = withClassName(styles$g)(dxReactChart.ZoomAndPan.DragBox);
