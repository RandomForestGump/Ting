        ...
        return (createElement(Plugin, null,
            ...
            createElement(Template, { name: "canvas" },
                createElement("div", { id: "center-center", ref: this.ref, style: { display: 'flex', flexDirection: 'column', flexGrow: 1 } },
                    createElement("div", { id: TOP + "-axis-container", style: { display: 'flex', flexDirection: 'row' } },
                    ...
                    createElement("div", { id: BOTTOM + "-axis-container", style: { display: 'flex', flexDirection: 'row' } },
...
var SizerContainer = function (_a) {
    ...
    return (createElement("div", { style: DIV_STYLE }, children));
};
var numDefs = 0;
...
var ComponentLayout = function () { return (createElement(Plugin, { name: "ComponentLayout" },
    createElement(Template, { name: "canvas" },
        createElement("div", { id: TOP + "-container", style: { display: 'flex', flexDirection: 'row' } },
            createElement(TemplatePlaceholder, { name: TOP + "-" + LEFT }),
            createElement(TemplatePlaceholder, { name: TOP }),
            createElement(TemplatePlaceholder, { name: TOP + "-" + RIGHT })),
        ...
        createElement("div", { id: BOTTOM + "-container", style: { display: 'flex', flexDirection: 'row' } },
            createElement(TemplatePlaceholder, { name: BOTTOM + "-" + LEFT }),
            createElement(TemplatePlaceholder, { name: BOTTOM }),
            createElement(TemplatePlaceholder, { name: BOTTOM + "-" + RIGHT }))))); };
...
var Root = /*#__PURE__*/ (function (_super) {
    ...
    Root.prototype.render = function () {
        ...
        return (createElement("div", __assign({ style: __assign(__assign(__assign({}, style), { height: height + "px" }), width ? { width: width + "px" } : null) }, restProps), children));
    };
    return Root;
}(PureComponent));
    ...
    RawLegend.prototype.render = function () {
        ...
        return (createElement(Plugin, { name: "Legend" },
            createElement(Template, { name: placeholder },
                createElement(TemplatePlaceholder, null),
                createElement(TemplateConnector, null, function (getters) { return (createElement(Root, { name: "legend-" + placeholder }, getItems(getters).map(function (_a) {
...
var withPattern = function (getPatternId, props) { return function (Target) { return function (targetProps) {
    ...
    return (createElement(Fragment, null,
        createElement(Target, __assign({ color: "url(#" + patternId + ")" }, restProps)),
...
var RawArea = /*#__PURE__*/ (function (_super) {
    ...
    RawArea.prototype.render = function () {
        ...
        return (createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: dPath(coordinates), fill: color, opacity: 0.5 }, restProps)));
    };
    return RawArea;
}(PureComponent));
...
var RawPath = /*#__PURE__*/ (function (_super) {
    ...
    RawPath.prototype.render = function () {
        ...
        return (createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: path(coordinates), fill: "none", strokeWidth: 2, stroke: color }, restProps)));
    };
    return RawPath;
}(PureComponent));
...
var RawSlice = /*#__PURE__*/ (function (_super) {
    ...
    RawSlice.prototype.render = function () {
        ...
        return (createElement("g", { transform: "translate(" + arg + " " + val + ")" },
...
var RawPoint = /*#__PURE__*/ (function (_super) {
    ...
    RawPoint.prototype.render = function () {
        ...
        return (createElement("path", __assign({ transform: "translate(" + x + " " + y + ")", d: dSymbol(pointOptions), fill: color, visibility: visibility, stroke: "none" }, restProps)));
    };
    return RawPoint;
}(PureComponent));
...
var Root$1 = /*#__PURE__*/ (function (_super) {
    ...
    Root.prototype.render = function () {
        ...
        return (createElement("g", __assign({ ref: this.ref, transform: "translate(" + x + " " + y + ")" }, restProps), children));
    };
    return Root;
}(PureComponent));
...
var Line$1 = /*#__PURE__*/ (function (_super) {
    ...
    Line.prototype.render = function () {
        ...
        return (createElement("path", __assign({ d: "M " + x1 + " " + y1 + " L " + x2 + " " + y2 }, restProps)));
    };
    return Line;
}(PureComponent));
        ...
        return (createElement(Plugin, { name: "Tooltip", dependencies: dependencies },
            ...
            createElement(Template, { name: "series" },
                ...
                createElement(TemplateConnector, null, function (_a) {
                    ...
                    return (createElement(OverlayComponent, { key: "" + target.series + target.point, target: createReference(element, rootRef), rotated: rotated, arrowComponent: arrowComponent },
