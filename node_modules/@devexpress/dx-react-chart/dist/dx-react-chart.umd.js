...
(function (global, factory) {
    ...
    (global = global || self, factory((global.DevExpress = global.DevExpress || {}, global.DevExpress.DXReactChart = {}), global.React, global.DevExpress.DXReactCore, global.DevExpress.DXChartCore, global.d3Shape));
    ...
    ***************************************************************************** */
            ...
            return (React.createElement(dxReactCore.Plugin, null,
                ...
                React.createElement(dxReactCore.Template, { name: "canvas" },
                    React.createElement("div", { id: "center-center", ref: this.ref, style: { display: 'flex', flexDirection: 'column', flexGrow: 1 } },
                        React.createElement("div", { id: dxChartCore.TOP + "-axis-container", style: { display: 'flex', flexDirection: 'row' } },
                        ...
                        React.createElement("div", { id: dxChartCore.BOTTOM + "-axis-container", style: { display: 'flex', flexDirection: 'row' } },
    ...
    var SizerContainer = function (_a) {
        ...
        return (React.createElement("div", { style: DIV_STYLE }, children));
    };
    var numDefs = 0;
    ...
    var ComponentLayout = function () { return (React.createElement(dxReactCore.Plugin, { name: "ComponentLayout" },
        React.createElement(dxReactCore.Template, { name: "canvas" },
            React.createElement("div", { id: dxChartCore.TOP + "-container", style: { display: 'flex', flexDirection: 'row' } },
                ...
                React.createElement(dxReactCore.TemplatePlaceholder, { name: dxChartCore.TOP + "-" + dxChartCore.RIGHT })),
            ...
            React.createElement("div", { id: dxChartCore.BOTTOM + "-container", style: { display: 'flex', flexDirection: 'row' } },
                ...
                React.createElement(dxReactCore.TemplatePlaceholder, { name: dxChartCore.BOTTOM + "-" + dxChartCore.RIGHT }))))); };
    ...
    var Root = /*#__PURE__*/ (function (_super) {
        ...
        Root.prototype.render = function () {
            ...
            return (React.createElement("div", __assign({ style: __assign(__assign(__assign({}, style), { height: height + "px" }), width ? { width: width + "px" } : null) }, restProps), children));
        };
        return Root;
    }(React.PureComponent));
    ...
    var scheme = [];
    var placeholders = [
        dxChartCore.TOP + "-" + dxChartCore.LEFT,
        dxChartCore.TOP + "-" + dxChartCore.RIGHT,
        dxChartCore.BOTTOM + "-" + dxChartCore.LEFT,
        dxChartCore.BOTTOM + "-" + dxChartCore.RIGHT,
        dxChartCore.TOP + "-" + dxChartCore.LEFT + "-axis",
        dxChartCore.TOP + "-" + dxChartCore.RIGHT + "-axis",
        dxChartCore.BOTTOM + "-" + dxChartCore.LEFT + "-axis",
        dxChartCore.BOTTOM + "-" + dxChartCore.RIGHT + "-axis",
    ];
        ...
        RawLegend.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "Legend" },
                React.createElement(dxReactCore.Template, { name: placeholder },
                    React.createElement(dxReactCore.TemplatePlaceholder, null),
                    React.createElement(dxReactCore.TemplateConnector, null, function (getters) { return (React.createElement(Root, { name: "legend-" + placeholder }, getItems(getters).map(function (_a) {
    ...
    var withPattern = function (getPatternId, props) { return function (Target) { return function (targetProps) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Target, __assign({ color: "url(#" + patternId + ")" }, restProps)),
    ...
    var RawArea = /*#__PURE__*/ (function (_super) {
        ...
        RawArea.prototype.render = function () {
            ...
            return (React.createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: dPath(coordinates), fill: color, opacity: 0.5 }, restProps)));
        };
        return RawArea;
    }(React.PureComponent));
    ...
    var RawPath = /*#__PURE__*/ (function (_super) {
        ...
        RawPath.prototype.render = function () {
            ...
            return (React.createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: path(coordinates), fill: "none", strokeWidth: 2, stroke: color }, restProps)));
        };
        return RawPath;
    }(React.PureComponent));
    ...
    var RawSlice = /*#__PURE__*/ (function (_super) {
        ...
        RawSlice.prototype.render = function () {
            ...
            return (React.createElement("g", { transform: "translate(" + arg + " " + val + ")" },
    ...
    var RawPoint = /*#__PURE__*/ (function (_super) {
        ...
        RawPoint.prototype.render = function () {
            ...
            return (React.createElement("path", __assign({ transform: "translate(" + x + " " + y + ")", d: dxChartCore.dSymbol(pointOptions), fill: color, visibility: visibility, stroke: "none" }, restProps)));
        };
        return RawPoint;
    }(React.PureComponent));
    ...
    var Root$1 = /*#__PURE__*/ (function (_super) {
        ...
        Root.prototype.render = function () {
            ...
            return (React.createElement("g", __assign({ ref: this.ref, transform: "translate(" + x + " " + y + ")" }, restProps), children));
        };
        return Root;
    }(React.PureComponent));
    ...
    var Line$1 = /*#__PURE__*/ (function (_super) {
        ...
        Line.prototype.render = function () {
            ...
            return (React.createElement("path", __assign({ d: "M " + x1 + " " + y1 + " L " + x2 + " " + y2 }, restProps)));
        };
        return Line;
    }(React.PureComponent));
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "Tooltip", dependencies: dependencies },
                ...
                React.createElement(dxReactCore.Template, { name: "series" },
                    ...
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        return (React.createElement(OverlayComponent, { key: "" + target.series + target.point, target: dxChartCore.createReference(element, rootRef), rotated: rotated, arrowComponent: arrowComponent },
