...
var SharedTooltipContent_1 = require("./SharedTooltipContent");
...
var SeriesTooltip = /** @class */ (function (_super) {
    ...
    SeriesTooltip.prototype.componentDidMount = function () {
        ...
        this.chartObserver = new kendo_charts_1.InstanceObserver(this, {
        ...
        var tooltipContent = this.state.popupShown ? function () {
            ...
            if (shared) {
                return render !== null ? render(popupContext) :
                    (React.createElement(SharedTooltipContent_1.SharedTooltipContent, __assign({}, popupContext)));
            }
            else {
    ...
    SeriesTooltip.prototype.createSharedTooltipContext = function (e) {
        ...
        return {
            ...
            points: e.points.map(function (point) { return new Point_1.TooltipPoint(point, e.format); })
        };
    };
    SeriesTooltip.prototype.createTooltipContext = function (e) {
        var point = e.point, format = e.format;
        return { point: new Point_1.TooltipPoint(point, format) };
    };
    ...
    SeriesTooltip.contextType = ChartContext_1.ChartContext;
